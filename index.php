    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#menu">Ofertas</a></li>
    ...
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="btns">
            <a href="list.php" class="btn-menu animated fadeInUp scrollto">lista de esperaaa</a>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="assets/img/lotCoin.jpg" class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">1º Lote</a><span>$5.95</span>
            </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="assets/img/lotCoin.jpg" class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">2º Lote</a><span>$5.95</span>
            </div>
            <div class="menu-ingredients">
              Data: 01/01/2022 à 08/01/2022
            </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="assets/img/lotCoin.jpg" class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">3º Lote</a><span>$5.95</span>
            </div>
            <div class="menu-ingredients">
              Data: 01/01/2022 à 08/01/2022
            </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="assets/img/lotCoin.jpg" class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">4º Lote</a><span>$5.95</span>
            </div>
            <div class="menu-ingredients">
              Data: 01/01/2022 à 08/01/2022
            </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="assets/img/lotCoin.jpg" class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">5º Lote</a><span>$5.95</span>
            </div>
            <div class="menu-ingredients">
              Data: 01/01/2022 à 08/01/2022
            </div>
    ...
    <!-- <section id="testimonials" class="testimonials section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Depoimentos</h2>
          <p>Agradecemos a confiança de todos!</p>
        </div>
    ...
    <!-- <section id="agenda" class="contact">
      <div class="container" data-aos="fade-up">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5 d-flex justify-content-center align-items-center">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="src/db/store.php" method="post" role="form">
              <div class="row">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-6 form-group date_nasc">
              ...
              <div class="row">
                  <div class="text-center m-1">
                    <button type="submit" class="submitAgenda" name="submitAgenda">Cadastrar atendimento</button>
                  </div>
              </div>
